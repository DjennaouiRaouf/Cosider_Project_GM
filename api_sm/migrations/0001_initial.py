# Generated by Django 4.2.7 on 2024-05-15 09:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.CharField(db_column='User_ID', default=django_currentuser.middleware.get_current_user, editable=False, max_length=15)),
                ('date_modification', models.DateTimeField(auto_now=True, db_column='Date_Modification')),
                ('agence', models.ForeignKey(db_column='Agence', on_delete=django.db.models.deletion.CASCADE, to='api_sch.tabagence', verbose_name='Agence')),
                ('avance', models.ForeignKey(blank=True, db_column='Avance', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.avance', verbose_name='Avance')),
                ...
                ('type', models.ForeignKey(db_column='Type_Caution', on_delete=django.db.models.deletion.DO_NOTHING, to='api_sm.typecaution', verbose_name='Libelle')),
            ],
            options={
