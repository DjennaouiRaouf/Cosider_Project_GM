    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('deleted', models.DateTimeField(db_index=True, editable=False, null=True)),
                ('deleted_by_cascade', models.BooleanField(default=False, editable=False)),
                ('id', models.CharField(db_column='id', editable=False, max_length=500, primary_key=True, serialize=False)),
                ('nt', models.CharField(db_column='NT', max_length=20)),
                ('libelle', models.TextField(blank=True, db_column='Libelle_NT', null=True)),
