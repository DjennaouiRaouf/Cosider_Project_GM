# Generated by Django 4.2.7 on 2024-04-22 07:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_commune_site', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sch.tabcommune', verbose_name='Commune')),
                ('code_division', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api_sch.tabdivision', verbose_name='Division')),
            ],
            options={
                'verbose_name': 'Sites',
